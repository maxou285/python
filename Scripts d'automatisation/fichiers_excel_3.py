...
wb1 = openpyxl.load_workbook("excel/octobre.xlsx", data_only=True)
wb2 = openpyxl.load_workbook("excel/novembre.xlsx", data_only=True)
wb3 = openpyxl.load_workbook("excel/decembre.xlsx", data_only=True)
